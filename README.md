...
- [JavaScript](./docs/js/js.md)

- [笔试题](./docs/code/code.md)

- [TypeScript](./docs/typescript/typescript.md)

- [Vue](./docs/vue/vue.md)

- [Webpack 和前端工程化](./docs/webpack/webpack.md)

- [微信小程序](./docs/mini-program/mini-program.md)
...
CSRF(Cross Site Request Forgery)，即跨站请求伪造，是一种常见的Web攻击，它利用用户已登录的身份，在用户毫不知情的情况下，以用户的名义完成非法操作。可以通过设置 Cookie 的 SameSite 设置 Cookie 不能跨域访问，也可以通过 Token 来避免 CSRF 攻击。

#### 4. 暴力破解

攻击者通过穷举的方式对用户密码进行爆破。一般通过验证码、非人机验证、密码多次输入错误后延长输入时间等方式进行防范。
